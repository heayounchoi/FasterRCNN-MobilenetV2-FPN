...
class FasterRCNNTrainer(nn.Module):
    ...
    def forward(self, imgs, bboxes, labels, scale):
        ...
        rpn_feature_maps, mrcnn_feature_maps = self.faster_rcnn.extractor(imgs)

        rpn_locs, rpn_scores, rois, roi_indices, anchor = self.faster_rcnn.rpn(
            rpn_feature_maps, img_size, scale)
    ...
    def save(self, epoch, save_optimizer=True, save_path=None, **kwargs):
        save_dict = dict()
